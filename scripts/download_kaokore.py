...
try:
    ...
    tqdm = None
    print(
        "Install tqdm (pip install tqdm) for a fancy progressbar with estimated remaining time - falling back to basic progressbar"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_version", type=str, help="The version of dataset", default="1.0", choices=["1.0", "1.1", "1.2", "1.3"]
    )
